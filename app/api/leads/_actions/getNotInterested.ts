...
export default async function getNotInterested(req: any) {
	...
	const [rows] = await pool.query(
        ...
        SELECT carsToBuy.*,
            ...
            contacts.phoneNumber AS contactPhoneNumber, contacts.notInterested AS contactNotInterested, contacts.isConfirmed AS contactIsConfirmed, contacts.isCommerciant AS contactIsCommerciant,
        ...
        WHERE carsToBuy.spokiInterested = "notInterested"
